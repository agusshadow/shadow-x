...
$view = View::validate($_GET['sec'] ?? 'dashboard');
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-success">
            <div class="container">
                <h1 class="m-unset"">
                    <a class="navbar-brand logo navbar-item" href="index.php?sec=dashboard">shadow x</a>
                </h1>
                ...
                <div class="collapse navbar-collapse navbar-item" id="navbarSupportedContent">
                    ...
                    <ul class="ms-auto mb-2 mb-lg-0"> 
                        ...
                        <li class="nav-item <?= $userData ? "" : "d-none" ?>">
                            <a class="nav-link fw-bold" href="actions/auth/logout.php">(<?= $userData["name"] ?>) Cerrar sesion <span class="fw-light"></span></a>
                        </li>
                    </ul>
                </div>
            </div>
