<section class="container py-5">
  ...
  <div class="row">
    <div class="col-12 col-md-6 my-auto">
      <h2 class="mb-3 fw-bold text-success">Quienes somos?</h2>
...
<section class="container py-5">
  ...
  <div class="row">
    ...
    <div class="col-12 col-md-6 my-auto">
      <h2 class="mb-3 fw-bold text-success">Que vendemos?</h2>
...
<section class="container py-5">
  ...
  <div class="row">
    <div class="col-12 col-md-6 my-auto">
      <h2 class="mb-3 fw-bold text-success">Nuestras marcas</h2>
